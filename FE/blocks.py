...
def dido_gen(name, not_name, nand2_name):
    ...
    circuit.X(0 ,pmos_device,'BL_' ,'net6','VDD','VDD',   l='0.15',w='2')
    circuit.X(1 ,pmos_device,'BL'  ,'net6','BL_','VDD',   l='0.15',w='2') 
    circuit.X(2 ,pmos_device,'BL'  ,'net6','VDD','VDD',   l='0.15',w='2') 
    ...
    circuit.X(7 ,pmos_device,'BL_' ,'net3','DR_','VDD',   l='0.15',w='1') 
    circuit.X(8 ,pmos_device,'DR'  ,'net3','BL' ,'VDD',   l='0.15',w='1') 
    circuit.X(9 ,pmos_device,'net4','SEL' ,'VDD','VDD',   l='0.15',w='0.42' )
    circuit.X(10,nmos_device,'BL'  ,'net2','DW' ,'VSS',   l='0.15',w='2' )
    circuit.X(11,nmos_device,'DW_' ,'net2','BL_','VSS',   l='0.15',w='2' )
