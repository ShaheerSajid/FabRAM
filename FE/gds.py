...
def gen_gds(mem_words, mem_bits, col_mux):
    ...
    cellarray = gdspy.CellArray(lib.cells[cellnames['bit_cell']],
                                num_bits,1,
                                [lib.cells[cellnames['bit_cell']].get_bounding_box()[1][0],
                                lib.cells[cellnames['bit_cell']].get_bounding_box()[1][1]],
                                [0,0])
    #add cell
    ...
    matarray = gdspy.CellArray(lib.cells[cell_prefix+str(num_bits)],
                                1,num_words,
                                [lib.cells[cell_prefix+str(num_bits)].get_bounding_box()[1][0],
                                lib.cells[cell_prefix+str(num_bits)].get_bounding_box()[1][1]],
                                [0,0])
    #add cell
    ...
    #     pre_dec_lines_Xs.append(p[0][0]+l_w/2)
